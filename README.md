...
Welcome to my personal configuration files. This repository contains my customized setup for a Hyprland environment on Linux.
...
Note: For other distributions (Fedora, Debian, etc.), package names may differ, and you may need to build Hyprland tools from source.
